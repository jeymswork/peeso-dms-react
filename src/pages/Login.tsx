...
const Login = () => {
  return (
    <div className='w-screen h-screen overflow-hidden flex font-sans'>
        <div className='w-1/2 h-full bg-peesoGreen flex items-center justify-center flex-col z-50'>
        ...
        <img src={wave} alt="wave" className='absolute h-full overflow-hidden object-contain z-40 right-[45vw]' />
        <div className='w-1/2 h-full bg-peesoOffWhite flex flex-col items-center justify-center'>
            ...
            <button className='text-base font-bold mt-10 outline-lime-800 bg-peesoGreen h-11 rounded w-1/2 text-peesoOffWhite hover:bg-peesoGreenHover'>LOGIN</button>
        </div>
    </div>
  )
}
